  ...
  playa: {
    ...
    images: [
      ...
      },
      {
        ...
        hotspots: [
          { wort: "el sol", clickX: 28.03, clickY: 17.97, labelX: 33, labelY: 15, areaW: 14, areaH: 14, shape: "circle" },
          { wort: "la gaviota", clickX: 68.95, clickY: 18.03, labelX: 67, labelY: 13 },
          { wort: "el socorrista", clickX: 71.48, clickY: 42.71, labelX: 80, labelY: 35, areaW: 14, areaH: 28 },
          ...
          { wort: "el flotador", clickX: 89.16, clickY: 62.17, labelX: 82, labelY: 55, areaW: 17, areaH: 17, shape: "circle" }
        ]
      },
      {

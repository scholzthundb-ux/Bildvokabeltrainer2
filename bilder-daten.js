...
window.APP_FOLDERS = {
    ...
    images: [
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: { es: "el comedor", de: "das Esszimmer", en: "the dining room", ru: "столовая" }, clickX: 51.5, clickY: 51.0, labelX: 51, labelY: 51, areaW: 16, areaH: 18, openFolderKey: "comedor", openDelay: 900 },
          ...
          { wort: { es: "el pasillo", de: "der Flur", en: "the hallway", ru: "прихожая" }, clickX: 38.5, clickY: 56.0, labelX: 39.0, labelY: 60.0, areaW: 9, areaH: 18 },
          { wort: { es: "el pasillo", de: "der Flur", en: "the hallway", ru: "прихожая" }, clickX: 40.5, clickY: 74.0, labelX: 39.0, labelY: 60.0, areaW: 9, areaH: 12 },
    ...
    images: [
      {
        ...
        hotspots: [
          ...
          { wort: { es: "el pasillo", de: "der Flur", en: "the hallway", ru: "прихожая" }, clickX: 43.0, clickY: 70.0, labelX: 39.0, labelY: 60.0, areaW: 9, areaH: 18, openFolderKey: "pasillo", openDelay: 900 },
  ...
  comedor: {
    ...
    images: [
      {
        title: "El comedor – Bild 1",
        file: "comedor1.png",
        openLabel: { wort: { es: "el comedor", de: "das Esszimmer", en: "the dining room", ru: "столовая" }, labelX: 50, labelY: 9 },
        hotspots: [
          { wort: { es: "la ventana", de: "das Fenster", en: "the window", ru: "окно" }, clickX: 8.0, clickY: 29.0, labelX: 14.0, labelY: 23.0, areaW: 14, areaH: 32 },
          { wort: { es: "la cortina", de: "der Vorhang", en: "the curtain", ru: "штора" }, clickX: 28.0, clickY: 25.0, labelX: 34.0, labelY: 19.0, areaW: 12, areaH: 28 },
          { wort: { es: "la lámpara", de: "die Lampe", en: "the lamp", ru: "лампа" }, clickX: 48.0, clickY: 27.0, labelX: 55.0, labelY: 22.0, areaW: 14, areaH: 18 },
          { wort: { es: "la puerta", de: "die Tür", en: "the door", ru: "дверь" }, clickX: 69.0, clickY: 24.0, labelX: 75.0, labelY: 19.0, areaW: 13, areaH: 23 },
          { wort: { es: "la vitrina", de: "die Vitrine", en: "the display cabinet", ru: "витрина" }, clickX: 91.0, clickY: 21.0, labelX: 84.0, labelY: 16.0, areaW: 17, areaH: 26 },
          { wort: { es: "el cuadro", de: "das Bild", en: "the picture", ru: "картина" }, clickX: 39.0, clickY: 44.0, labelX: 46.0, labelY: 39.0, areaW: 12, areaH: 14 },
          { wort: { es: "el aparador", de: "das Sideboard", en: "the sideboard", ru: "сервант" }, clickX: 23.5, clickY: 62.0, labelX: 31.0, labelY: 57.0, areaW: 23, areaH: 20 },
          { wort: { es: "el jarrón con flores", de: "die Blumenvase", en: "the vase with flowers", ru: "ваза с цветами" }, clickX: 24.0, clickY: 50.0, labelX: 31.0, labelY: 46.0, areaW: 12, areaH: 14 },
          { wort: { es: "la mesa", de: "der Tisch", en: "the table", ru: "стол" }, clickX: 51.0, clickY: 63.0, labelX: 58.0, labelY: 58.0, areaW: 39, areaH: 22 },
          { wort: { es: "la botella", de: "die Flasche", en: "the bottle", ru: "бутылка" }, clickX: 51.5, clickY: 61.0, labelX: 58.0, labelY: 55.5, areaW: 9, areaH: 14 },
          ...
          { wort: { es: "la silla", de: "der Stuhl", en: "the chair", ru: "стул" }, clickX: 15.0, clickY: 83.0, labelX: 22.0, labelY: 78.0, areaW: 18, areaH: 23 },
          { wort: { es: "la alfombra", de: "der Teppich", en: "the rug", ru: "ковёр" }, clickX: 76.0, clickY: 95.0, labelX: 71.0, labelY: 89.0, areaW: 38, areaH: 11 }
        ]
      }
    ]
  },
    ...
    images: [
      {
        ...
        hotspots: [
          ...
          { wort: { es: "el armario", de: "der Kleiderschrank", en: "the wardrobe", ru: "шкаф" }, clickX: 68.5, clickY: 34.0, labelX: 77.0, labelY: 24.0, areaW: 22, areaH: 38 },
          ...
          { wort: { es: "la lámpara de noche", de: "die Nachttischlampe", en: "the bedside lamp", ru: "прикроватная лампа" }, clickX: 6.0, clickY: 56.5, labelX: 13.5, labelY: 53.0, areaW: 8, areaH: 14 },
          ...
          { wort: { es: "la manta", de: "die Decke", en: "the blanket", ru: "одеяло" }, clickX: 44.0, clickY: 64.0, labelX: 52.0, labelY: 61.5, areaW: 30, areaH: 16 },
          { wort: { es: "la cama", de: "das Bett", en: "the bed", ru: "кровать" }, clickX: 70.0, clickY: 69.0, labelX: 69.0, labelY: 72.0, areaW: 18, areaH: 18 },
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: { es: "el techo", de: "die Decke", en: "the ceiling", ru: "потолок" }, clickX: 49.9, clickY: 17.7, labelX: 50, labelY: 9.5, areaW: 31.4, areaH: 33.5 },
          { wort: { es: "el techo inclinado", de: "die Dachschräge", en: "the sloping ceiling", ru: "скошенный потолок" }, clickX: 82.2, clickY: 17.7, labelX: 76, labelY: 9.5, areaW: 32.6, areaH: 33.5 },
          { wort: { es: "la ventana", de: "das Fenster", en: "the window", ru: "окно" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "la ventana del tejado", de: "das Dachfenster", en: "the roof window", ru: "мансардное окно" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "el alféizar", de: "die Fensterbank", en: "the windowsill", ru: "подоконник" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
          { wort: { es: "la persiana", de: "der Rollladen", en: "the roller shutter", ru: "рольставня" }, clickX: 17.6, clickY: 83.1, labelX: 24, labelY: 75, areaW: 32.4, areaH: 31.8 },
          { wort: { es: "la veneciana", de: "die Jalousie", en: "the Venetian blind", ru: "жалюзи" }, clickX: 49.9, clickY: 83.1, labelX: 50, labelY: 75, areaW: 31.4, areaH: 31.8 },
          { wort: { es: "la cortina", de: "der Vorhang", en: "the curtain", ru: "штора" }, clickX: 82.2, clickY: 83.1, labelX: 76, labelY: 75, areaW: 32.6, areaH: 31.8 }
        ]
      },
      {
      ...
      },
      {
        ...
        hotspots: [
          { wort: { es: "el cajón de la cama", de: "die Bettschublade", en: "the bed drawer", ru: "выдвижной ящик кровати" }, clickX: 17.6, clickY: 17.7, labelX: 24, labelY: 9.5, areaW: 32.4, areaH: 33.5 },
          ...
          { wort: { es: "el somier", de: "der Lattenrost", en: "the slatted bed base", ru: "реечное основание кровати" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "el colchón", de: "die Matratze", en: "the mattress", ru: "матрас" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "la mesita de noche", de: "der Nachttisch", en: "the bedside table", ru: "прикроватная тумбочка" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
      ...
      {
        title: "El dormitorio – Bild 7",
        file: "dormitorio7.png",
        hotspots: [
          ...
          { wort: { es: "la estantería", de: "das Regal", en: "the shelving unit", ru: "стеллаж" }, clickX: 82.2, clickY: 17.7, labelX: 76, labelY: 9.5, areaW: 32.6, areaH: 33.5 },
          { wort: { es: "la balda", de: "das Wandbrett / Regalbrett", en: "the wall shelf", ru: "настенная полка" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "el espejo", de: "der Spiegel", en: "the mirror", ru: "зеркало" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "la lámpara de techo", de: "die Deckenlampe", en: "the ceiling lamp", ru: "потолочная лампа" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
          { wort: { es: "la lámpara de noche", de: "die Nachttischlampe", en: "the bedside lamp", ru: "прикроватная лампа" }, clickX: 17.6, clickY: 83.1, labelX: 24, labelY: 75, areaW: 32.4, areaH: 31.8 },
    ...
    images: [
      {
        ...
        hotspots: [
          ...
          { wort: { es: "la aspiradora", de: "der Staubsauger", en: "the vacuum cleaner", ru: "пылесос" }, clickX: 39.5, clickY: 55.0, labelX: 58.0, labelY: 51.0, areaW: 18, areaH: 24 },
    ...
    images: [
      {
        ...
        hotspots: [
          { wort: { es: "la olla", de: "der Kochtopf", en: "the pot", ru: "кастрюля" }, clickX: 16.7, clickY: 16.9, labelX: 16.7, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la tapa", de: "der Deckel", en: "the lid", ru: "крышка" }, clickX: 50.0, clickY: 16.9, labelX: 50.0, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la sartén", de: "die Pfanne", en: "the frying pan", ru: "сковорода" }, clickX: 83.3, clickY: 16.9, labelX: 83.3, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la olla exprés", de: "der Schnellkochtopf", en: "the pressure cooker", ru: "скороварка" }, clickX: 16.7, clickY: 50.0, labelX: 16.7, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la cazuela", de: "der Schmortopf", en: "the saucepan", ru: "кастрюля" }, clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el escurridor", de: "der Abtropfer", en: "the drainer", ru: "сушилка" }, clickX: 83.3, clickY: 50.0, labelX: 83.3, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el colador", de: "das Sieb", en: "the sieve", ru: "сито" }, clickX: 16.7, clickY: 83.1, labelX: 16.7, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el bol para mezclar", de: "die Rührschüssel", en: "the mixing bowl", ru: "миска для смешивания" }, clickX: 50.0, clickY: 83.1, labelX: 50.0, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el cucharón", de: "die Suppenkelle", en: "the ladle", ru: "половник" }, clickX: 83.3, clickY: 83.1, labelX: 83.3, labelY: 76.5, areaW: 32.3, areaH: 32.3 }
        ]
      },
      {
      ...
      },
      {
        ...
        file: "cocina9.png",
        hotspots: [
          { wort: { es: "el abrebotellas", de: "der Flaschenöffner", en: "the bottle opener", ru: "открывалка для бутылок" }, clickX: 16.7, clickY: 16.9, labelX: 16.7, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el abrelatas", de: "der Dosenöffner", en: "the tin opener", ru: "консервный нож" }, clickX: 50.0, clickY: 16.9, labelX: 50.0, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el sacacorchos", de: "der Korkenzieher", en: "the corkscrew", ru: "штопор" }, clickX: 83.3, clickY: 16.9, labelX: 83.3, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la tabla de cortar", de: "das Schneidebrett", en: "the chopping board", ru: "разделочная доска" }, clickX: 16.7, clickY: 50.0, labelX: 16.7, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el rallador", de: "die Reibe", en: "the grater", ru: "тёрка" }, clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el mortero", de: "der Mörser", en: "the mortar", ru: "ступка" }, clickX: 83.3, clickY: 50.0, labelX: 83.3, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el exprimidor", de: "die Zitronenpresse", en: "the juicer", ru: "соковыжималка" }, clickX: 16.7, clickY: 83.1, labelX: 16.7, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el embudo", de: "der Trichter", en: "the funnel", ru: "воронка" }, clickX: 50.0, clickY: 83.1, labelX: 50.0, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el hervidor de agua", de: "der Wasserkocher", en: "the kettle", ru: "чайник" }, clickX: 83.3, clickY: 83.1, labelX: 83.3, labelY: 76.5, areaW: 32.3, areaH: 32.3 }
        ]
      },
      {
      ...
      },
      {
        ...
        file: "cocina10.png",
        hotspots: [
          { wort: { es: "el temporizador", de: "der Timer", en: "the timer", ru: "таймер" }, clickX: 16.7, clickY: 16.9, labelX: 16.7, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la cucharilla medidora", de: "der Messlöffel", en: "the measuring spoon", ru: "мерная ложка" }, clickX: 50.0, clickY: 16.9, labelX: 50.0, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el mantel", de: "die Tischdecke", en: "the tablecloth", ru: "скатерть" }, clickX: 83.3, clickY: 16.9, labelX: 83.3, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la servilleta", de: "die Serviette", en: "the napkin", ru: "салфетка" }, clickX: 16.7, clickY: 50.0, labelX: 16.7, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el paño de cocina", de: "das Geschirrtuch", en: "the tea towel", ru: "кухонное полотенце" }, clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el trapo", de: "der Lappen", en: "the cloth", ru: "тряпка" }, clickX: 83.3, clickY: 50.0, labelX: 83.3, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el salvamanteles", de: "der Untersetzer", en: "the trivet", ru: "подставка под горячее" }, clickX: 16.7, clickY: 83.1, labelX: 16.7, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el delantal", de: "die Schürze", en: "the apron", ru: "фартук" }, clickX: 50.0, clickY: 83.1, labelX: 50.0, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el guante de cocina", de: "der Ofenhandschuh", en: "the oven glove", ru: "кухонная рукавица" }, clickX: 83.3, clickY: 83.1, labelX: 83.3, labelY: 76.5, areaW: 32.3, areaH: 32.3 }
        ]
      }
    ]
  },
    ...
    images: [
      {
        ...
        hotspots: [
          { wort: { es: "los cubiertos", de: "das Besteck", en: "the cutlery", ru: "столовые приборы" }, clickX: 16.7, clickY: 16.9, labelX: 16.7, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el tenedor", de: "die Gabel", en: "the fork", ru: "вилка" }, clickX: 50.0, clickY: 16.9, labelX: 50.0, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la cuchara", de: "der Löffel", en: "the spoon", ru: "ложка" }, clickX: 83.3, clickY: 16.9, labelX: 83.3, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la cucharilla", de: "der Teelöffel", en: "the teaspoon", ru: "чайная ложка" }, clickX: 16.7, clickY: 50.0, labelX: 16.7, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el cuchillo", de: "das Messer", en: "the knife", ru: "нож" }, clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el plato", de: "der Teller", en: "the plate", ru: "тарелка" }, clickX: 83.3, clickY: 50.0, labelX: 83.3, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el plato pequeño", de: "der kleine Teller", en: "the side plate", ru: "маленькая тарелка" }, clickX: 16.7, clickY: 83.1, labelX: 16.7, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el plato hondo", de: "der tiefe Teller", en: "the deep plate", ru: "глубокая тарелка" }, clickX: 50.0, clickY: 83.1, labelX: 50.0, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el plato llano", de: "der flache Teller", en: "the dinner plate", ru: "плоская тарелка" }, clickX: 83.3, clickY: 83.1, labelX: 83.3, labelY: 76.5, areaW: 32.3, areaH: 32.3 }
        ]
      },
      {
        ...
        file: "cocina8.png",
        hotspots: [
          { wort: { es: "la taza", de: "die Tasse", en: "the cup", ru: "чашка" }, clickX: 16.7, clickY: 16.9, labelX: 16.7, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el bol", de: "die Schüssel", en: "the bowl", ru: "миска" }, clickX: 50.0, clickY: 16.9, labelX: 50.0, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "el vaso", de: "das Glas", en: "the glass", ru: "стакан" }, clickX: 83.3, clickY: 16.9, labelX: 83.3, labelY: 10.3, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la jarra de cerveza", de: "der Bierkrug", en: "the beer mug", ru: "пивная кружка" }, clickX: 16.7, clickY: 50.0, labelX: 16.7, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la copa de vino", de: "das Weinglas", en: "the wine glass", ru: "бокал для вина" }, clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la copa de cava", de: "das Sektglas", en: "the champagne flute", ru: "бокал для шампанского" }, clickX: 83.3, clickY: 50.0, labelX: 83.3, labelY: 43.4, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la cafetera", de: "die Kaffeekanne", en: "the coffee pot", ru: "кофейник" }, clickX: 16.7, clickY: 83.1, labelX: 16.7, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la tetera", de: "die Teekanne", en: "the teapot", ru: "заварочный чайник" }, clickX: 50.0, clickY: 83.1, labelX: 50.0, labelY: 76.5, areaW: 32.3, areaH: 32.3 },
          { wort: { es: "la jarra", de: "der Krug", en: "the jug", ru: "кувшин" }, clickX: 83.3, clickY: 83.1, labelX: 83.3, labelY: 76.5, areaW: 32.3, areaH: 32.3 }
        ]
      },
      {
    ...
    images: [
      {
        ...
        hotspots: [
          ...
          { wort: { es: "la lámpara", de: "die Lampe", en: "the lamp", ru: "лампа" }, clickX: 54.8, clickY: 31.8, labelX: 57, labelY: 27.2, areaW: 14, areaH: 14 },
          ...
          { wort: { es: "la silla plegable", de: "der Klappstuhl", en: "the folding chair", ru: "складной стул" }, clickX: 16.0, clickY: 71.6, labelX: 23, labelY: 67.2, areaW: 26, areaH: 23 },
          { wort: { es: "el baúl", de: "die Truhe", en: "the trunk", ru: "сундук" }, clickX: 74.5, clickY: 59.0, labelX: 72, labelY: 54.0, areaW: 30, areaH: 14 },
          { wort: { es: "la escalera", de: "die Leiter", en: "the ladder", ru: "лестница" }, clickX: 89.5, clickY: 87.0, labelX: 87, labelY: 82.8, areaW: 21, areaH: 34 },
          { wort: { es: "la escalera", de: "die Leiter", en: "the ladder", ru: "лестница" }, clickX: 89.2, clickY: 63.5, labelX: 87, labelY: 58.8, areaW: 10, areaH: 24 },
    ...
    images: [
      {
        ...
        hotspots: [
          ...
          { wort: { es: "la lámpara", de: "die Lampe", en: "the lamp", ru: "лампа" }, clickX: 50.0, clickY: 16.5, labelX: 57.0, labelY: 15.0, areaW: 13, areaH: 13 },
          { wort: { es: "la puerta", de: "die Tür", en: "the door", ru: "дверь" }, clickX: 52.5, clickY: 41.0, labelX: 60.0, labelY: 29.0, areaW: 18, areaH: 36 },
          { wort: { es: "la pared", de: "die Wand", en: "the wall", ru: "стена" }, clickX: 82.0, clickY: 8.5, labelX: 71.0, labelY: 12.0, areaW: 36, areaH: 12 },
          { wort: { es: "el perchero", de: "die Garderobe", en: "the coat rack", ru: "вешалка" }, clickX: 86.0, clickY: 33.0, labelX: 74.5, labelY: 25.0, areaW: 17, areaH: 39 },
          ...
          { wort: { es: "la alfombra", de: "der Läufer", en: "the runner rug", ru: "дорожка" }, clickX: 56.0, clickY: 87.0, labelX: 66.0, labelY: 80.0, areaW: 33, areaH: 33 },
          { wort: { es: "la alfombra", de: "der Läufer", en: "the runner rug", ru: "дорожка" }, clickX: 52.0, clickY: 71.0, labelX: 66.0, labelY: 80.0, areaW: 18, areaH: 18 },
          { wort: { es: "el suelo", de: "der Fußboden", en: "the floor", ru: "пол" }, clickX: 88.0, clickY: 94.0, labelX: 81.0, labelY: 85.0, areaW: 24, areaH: 16 }
        ]
      },
      {
        ...
        file: "pasillo2.png",
        hotspots: [
          { wort: { es: "la mirilla", de: "der Türspion", en: "the peephole", ru: "глазок" }, clickX: 17.6, clickY: 17.7, labelX: 24, labelY: 9.5, areaW: 32.4, areaH: 33.5 },
          { wort: { es: "el suelo", de: "der Fußboden", en: "the floor", ru: "пол" }, clickX: 49.9, clickY: 17.7, labelX: 50, labelY: 9.5, areaW: 31.4, areaH: 33.5 },
          { wort: { es: "el espejo", de: "der Spiegel", en: "the mirror", ru: "зеркало" }, clickX: 82.2, clickY: 17.7, labelX: 76, labelY: 9.5, areaW: 32.6, areaH: 33.5 },
          { wort: { es: "el perchero", de: "die Garderobe", en: "the coat rack", ru: "вешалка" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "la alfombra", de: "der Läufer", en: "the runner rug", ru: "дорожка" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "la cómoda", de: "die Kommode", en: "the chest of drawers", ru: "комод" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
          { wort: { es: "el cuelgallaves", de: "das Schlüsselbrett", en: "the key holder", ru: "ключница" }, clickX: 17.6, clickY: 83.1, labelX: 24, labelY: 75, areaW: 32.4, areaH: 31.8 },
          { wort: { es: "las llaves", de: "die Schlüssel (Pl.)", en: "the keys", ru: "ключи" }, clickX: 49.9, clickY: 83.1, labelX: 50, labelY: 75, areaW: 31.4, areaH: 31.8 },
          { wort: { es: "el felpudo", de: "die Fußmatte", en: "the doormat", ru: "коврик у двери" }, clickX: 82.2, clickY: 83.1, labelX: 76, labelY: 75, areaW: 32.6, areaH: 31.8 }
        ]
      },
      {
        ...
        file: "pasillo3.png",
        hotspots: [
          { wort: { es: "el paragüero", de: "der Schirmständer", en: "the umbrella stand", ru: "подставка для зонтов" }, clickX: 17.6, clickY: 17.7, labelX: 24, labelY: 9.5, areaW: 32.4, areaH: 33.5 },
          { wort: { es: "el zapatero", de: "das Schuhregal", en: "the shoe rack", ru: "обувная полка" }, clickX: 49.9, clickY: 17.7, labelX: 50, labelY: 9.5, areaW: 31.4, areaH: 33.5 },
          { wort: { es: "el cuadro", de: "das Bild", en: "the picture", ru: "картина" }, clickX: 82.2, clickY: 17.7, labelX: 76, labelY: 9.5, areaW: 32.6, areaH: 33.5 },
          { wort: { es: "la planta", de: "die Pflanze", en: "the plant", ru: "растение" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "el interruptor", de: "der Lichtschalter", en: "the light switch", ru: "выключатель" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "el enchufe", de: "die Steckdose", en: "the socket", ru: "розетка" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
          { wort: { es: "el teléfono fijo", de: "das Festnetztelefon", en: "the landline phone", ru: "стационарный телефон" }, clickX: 17.6, clickY: 83.1, labelX: 24, labelY: 75, areaW: 32.4, areaH: 31.8 },
          { wort: { es: "el reloj de pared", de: "die Wanduhr", en: "the wall clock", ru: "настенные часы" }, clickX: 49.9, clickY: 83.1, labelX: 50, labelY: 75, areaW: 31.4, areaH: 31.8 },
          { wort: { es: "el portero automático", de: "die Gegensprechanlage", en: "the intercom", ru: "домофон" }, clickX: 82.2, clickY: 83.1, labelX: 76, labelY: 75, areaW: 32.6, areaH: 31.8 }
        ]
      }
    ]
  },
    ...
    images: [
      {
        ...
        hotspots: [
          ...
          { wort: { es: "el ordenador", de: "der Computer", en: "the computer", ru: "компьютер" }, clickX: 65.5, clickY: 46.5, labelX: 73.5, labelY: 43.5, areaW: 11, areaH: 11 },
          ...
          { wort: { es: "la carpeta", de: "die Mappe", en: "the folder", ru: "папка" }, clickX: 58.0, clickY: 57.0, labelX: 66.5, labelY: 54.0, areaW: 18, areaH: 8 },
    ...
    images: [
      {
        ...
        hotspots: [
          { wort: { es: "la habitación infantil", de: "das Kinderzimmer", en: "the children's room", ru: "детская комната" }, clickX: 50.0, clickY: 25.0, labelX: 23.0, labelY: 12.0, areaW: 100, areaH: 49, openFolderKey: "cuartoInfantil", openDelay: 900 },
          { wort: { es: "la habitación juvenil", de: "das Jugendzimmer", en: "the teenager's room", ru: "комната подростка" }, clickX: 50.0, clickY: 75.0, labelX: 24.0, labelY: 62.0, areaW: 100, areaH: 46, openFolderKey: "cuartoJuvenil", openDelay: 900 }
        ]
      }
    ]
  },
  ...
  cuartoJuvenil: {
    ...
    images: [
      ...
      {
        title: "La habitación juvenil – Bild 2",
        file: "ninos10.png",
        hotspots: [
      ...
      {
        title: "La habitación juvenil – Bild 3",
        file: "ninos12.png",
        hotspots: [
      ...
      {
        title: "La habitación juvenil – Bild 4",
        file: "ninos13.png",
        hotspots: [
      ...
      {
        title: "La habitación juvenil – Bild 5",
        file: "ninos14.png",
        hotspots: [
          { wort: { es: "el libro", de: "das Buch", en: "the book", ru: "книга" }, clickX: 17.6, clickY: 17.7, labelX: 24, labelY: 9.5, areaW: 32.4, areaH: 33.5 },
          { wort: { es: "el papel", de: "das Papier", en: "the paper", ru: "бумага" }, clickX: 49.9, clickY: 17.7, labelX: 50, labelY: 9.5, areaW: 31.4, areaH: 33.5 },
          ...
          { wort: { es: "los rotuladores", de: "die Filzstifte", en: "the felt-tip pens", ru: "фломастеры" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          ...
          { wort: { es: "las tijeras", de: "die Schere", en: "the scissors", ru: "ножницы" }, clickX: 49.9, clickY: 83.1, labelX: 50, labelY: 75, areaW: 31.4, areaH: 31.8 },
      ...
      {
        title: "La habitación juvenil – Bild 6",
        file: "ninos15.png",
        hotspots: [
          ...
          { wort: { es: "escuchar música", de: "Musik hören", en: "to listen to music", ru: "слушать музыку" }, clickX: 49.9, clickY: 17.7, labelX: 50, labelY: 9.5, areaW: 31.4, areaH: 33.5 },
          { wort: { es: "ver la televisión", de: "fernsehen", en: "to watch television", ru: "смотреть телевизор" }, clickX: 82.2, clickY: 17.7, labelX: 76, labelY: 9.5, areaW: 32.6, areaH: 33.5 },
          { wort: { es: "navegar por internet", de: "im Internet surfen", en: "to browse the internet", ru: "сидеть в интернете" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "chatear con amigos", de: "mit Freunden chatten", en: "to chat with friends", ru: "общаться в чате с друзьями" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "llamar a un amigo", de: "einen Freund anrufen", en: "to call a friend", ru: "звонить другу" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
          { wort: { es: "grabar vídeos", de: "Videos aufnehmen", en: "to record videos", ru: "снимать видео" }, clickX: 17.6, clickY: 83.1, labelX: 24, labelY: 75, areaW: 32.4, areaH: 31.8 },
          { wort: { es: "hacer una videollamada", de: "einen Videoanruf machen", en: "to make a video call", ru: "делать видеозвонок" }, clickX: 49.9, clickY: 83.1, labelX: 50, labelY: 75, areaW: 31.4, areaH: 31.8 },
          { wort: { es: "sacar fotos", de: "Fotos machen", en: "to take photos", ru: "фотографировать" }, clickX: 82.2, clickY: 83.1, labelX: 76, labelY: 75, areaW: 32.6, areaH: 31.8 }
        ]
      },
      {
        title: "La habitación juvenil – Bild 7",
        file: "ninos16.png",
        hotspots: [
          ...
          { wort: { es: "tocar el teclado", de: "Keyboard spielen", en: "to play the keyboard", ru: "играть на клавишах" }, clickX: 49.9, clickY: 17.7, labelX: 50, labelY: 9.5, areaW: 31.4, areaH: 33.5 },
          { wort: { es: "cantar", de: "singen", en: "to sing", ru: "петь" }, clickX: 82.2, clickY: 17.7, labelX: 76, labelY: 9.5, areaW: 32.6, areaH: 33.5 },
          { wort: { es: "dibujar", de: "zeichnen", en: "to draw", ru: "рисовать" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "pintar", de: "malen", en: "to paint", ru: "рисовать красками" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "escribir un diario", de: "Tagebuch schreiben", en: "to keep a diary", ru: "вести дневник" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
          { wort: { es: "leer", de: "lesen", en: "to read", ru: "читать" }, clickX: 17.6, clickY: 83.1, labelX: 24, labelY: 75, areaW: 32.4, areaH: 31.8 },
          { wort: { es: "escuchar música", de: "Musik hören", en: "to listen to music", ru: "слушать музыку" }, clickX: 49.9, clickY: 83.1, labelX: 50, labelY: 75, areaW: 31.4, areaH: 31.8 },
          { wort: { es: "hacer una fiesta con amigos", de: "mit Freunden eine Party machen", en: "to have a party with friends", ru: "устраивать вечеринку с друзьями" }, clickX: 82.2, clickY: 83.1, labelX: 76, labelY: 75, areaW: 32.6, areaH: 31.8 }
        ]
      },
      {
        title: "La habitación juvenil – Bild 8",
        file: "ninos17.png",
        hotspots: [
          ...
          { wort: { es: "ordenar la habitación", de: "das Zimmer aufräumen", en: "to tidy the room", ru: "убирать комнату" }, clickX: 49.9, clickY: 17.7, labelX: 50, labelY: 9.5, areaW: 31.4, areaH: 33.5 },
          { wort: { es: "guardar la ropa", de: "die Wäsche wegräumen", en: "to put the clothes away", ru: "убирать одежду" }, clickX: 82.2, clickY: 17.7, labelX: 76, labelY: 9.5, areaW: 32.6, areaH: 33.5 },
          { wort: { es: "limpiar el escritorio", de: "den Schreibtisch aufräumen", en: "to clean the desk", ru: "убирать письменный стол" }, clickX: 17.6, clickY: 50.8, labelX: 24, labelY: 42, areaW: 32.4, areaH: 32.2 },
          { wort: { es: "estudiar", de: "lernen", en: "to study", ru: "учиться" }, clickX: 49.9, clickY: 50.8, labelX: 50, labelY: 42, areaW: 31.4, areaH: 32.2 },
          { wort: { es: "hacer los deberes", de: "Hausaufgaben machen", en: "to do homework", ru: "делать домашнее задание" }, clickX: 82.2, clickY: 50.8, labelX: 76, labelY: 42, areaW: 32.6, areaH: 32.2 },
          { wort: { es: "descansar", de: "sich ausruhen", en: "to rest", ru: "отдыхать" }, clickX: 17.6, clickY: 83.1, labelX: 24, labelY: 75, areaW: 32.4, areaH: 31.8 },
          { wort: { es: "preparar la mochila", de: "den Rucksack packen", en: "to pack the school bag", ru: "собирать рюкзак" }, clickX: 49.9, clickY: 83.1, labelX: 50, labelY: 75, areaW: 31.4, areaH: 31.8 },
          { wort: { es: "dormir", de: "schlafen", en: "to sleep", ru: "спать" }, clickX: 82.2, clickY: 83.1, labelX: 76, labelY: 75, areaW: 32.6, areaH: 31.8 }
        ]
      }
    ]

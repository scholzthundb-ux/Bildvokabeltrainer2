  ...
  casa: {
    ...
    images: [
      ...
      },
      {
        ...
        file: "haus16.png",
        hotspots: [
          { wort: "el bloque de pisos", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el piso", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el ascensor", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el patio", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la azotea", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la salida de emergencia", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el aparcabicis", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "los contenedores", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "la portería", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
      ...
      },
      {
        ...
        file: "Haus8.png",
        hotspots: [
          { wort: "el desván", clickX: 50, clickY: 16.5, labelX: 50, labelY: 12, areaW: 47, areaH: 18 },
          { wort: "la habitación infantil", clickX: 34.2, clickY: 33.5, labelX: 28, labelY: 38, areaW: 28, areaH: 17 },
    ...
    images: [
      {
        ...
        hotspots: [
          { wort: { es: "la nevera", de: "der Kühlschrank", en: "the fridge", ru: "холодильник" }, clickX: 7.5, clickY: 25.0, labelX: 17.5, labelY: 18.0, areaW: 15, areaH: 29 },
          { wort: { es: "el congelador", de: "der Gefrierschrank", en: "the freezer", ru: "морозильник" }, clickX: 10.0, clickY: 67.0, labelX: 20.0, labelY: 61.5, areaW: 16, areaH: 28 },
          { wort: { es: "el armario alto", de: "der Hängeschrank", en: "the wall cabinet", ru: "навесной шкаф" }, clickX: 30.0, clickY: 21.0, labelX: 38.0, labelY: 15.5, areaW: 18, areaH: 18 },
          { wort: { es: "la campana extractora", de: "die Dunstabzugshaube", en: "the extractor hood", ru: "вытяжка" }, clickX: 54.5, clickY: 19.5, labelX: 62.0, labelY: 13.5, areaW: 24, areaH: 18 },
          { wort: { es: "el grifo", de: "der Wasserhahn", en: "the tap", ru: "кран" }, clickX: 38.5, clickY: 41.5, labelX: 46.5, labelY: 37.0, areaW: 10, areaH: 14 },
          { wort: { es: "el fregadero", de: "das Spülbecken", en: "the sink", ru: "раковина" }, clickX: 36.5, clickY: 55.0, labelX: 46.0, labelY: 51.5, areaW: 26, areaH: 12 },
          { wort: { es: "la vitrocerámica", de: "das Cerankochfeld", en: "the ceramic hob", ru: "стеклокерамическая плита" }, clickX: 56.0, clickY: 48.5, labelX: 62.5, labelY: 44.5, areaW: 24, areaH: 12 },
          { wort: { es: "el horno", de: "der Backofen", en: "the oven", ru: "духовка" }, clickX: 53.5, clickY: 68.5, labelX: 60.0, labelY: 64.0, areaW: 18, areaH: 18 },
          { wort: { es: "los utensilios de cocina", de: "die Küchenutensilien", en: "the kitchen utensils", ru: "кухонные принадлежности" }, clickX: 73.5, clickY: 41.5, labelX: 82.0, labelY: 36.5, areaW: 12, areaH: 18 },
          { wort: { es: "la ventana", de: "das Fenster", en: "the window", ru: "окно" }, clickX: 86.0, clickY: 31.5, labelX: 78.0, labelY: 24.5, areaW: 12, areaH: 28 },
          { wort: { es: "la puerta", de: "die Tür", en: "the door", ru: "дверь" }, clickX: 97.0, clickY: 44.0, labelX: 88.5, labelY: 44.0, areaW: 6, areaH: 28 },
          { wort: { es: "el lavavajillas", de: "der Geschirrspüler", en: "the dishwasher", ru: "посудомоечная машина" }, clickX: 80.5, clickY: 65.5, labelX: 86.5, labelY: 60.5, areaW: 16, areaH: 24 },
          { wort: { es: "la mesa", de: "der Tisch", en: "the table", ru: "стол" }, clickX: 88.0, clickY: 80.5, labelX: 79.5, labelY: 86.5, areaW: 24, areaH: 18 },
          { wort: { es: "la silla", de: "der Stuhl", en: "the chair", ru: "стул" }, clickX: 69.5, clickY: 91.0, labelX: 74.5, labelY: 96.0, areaW: 18, areaH: 24 },
          { wort: { es: "la alfombra", de: "der Läufer", en: "the runner rug", ru: "дорожка" }, clickX: 33.5, clickY: 88.0, labelX: 43.0, labelY: 83.0, areaW: 42, areaH: 16 }
        ]
      },
      {
  ...
  cocinaMuebles: {
    ...
    images: [
      ...
      },
      {
        ...
        file: "cocina4.png",
        hotspots: [
          { wort: "el cajón", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la encimera", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la campana extractora", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la cocina de gas", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la cocina eléctrica", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la vitrocerámica", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la placa de inducción", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el horno", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la estufa", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
        ...
        file: "cocina5.png",
        hotspots: [
          { wort: "el fregadero", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el grifo", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la despensa", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el cubo de basura", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la papelera", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el especiero", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la barra para utensilios", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el portarrollos de cocina", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el escurreplatos", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      }
    ]
  },
    ...
    images: [
      {
        ...
        file: "cocina6.png",
        openLabel: { wort: "los utensilios de la cocina", labelX: 50, labelY: 14 },
        hotspots: [
          { wort: "la olla", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la tapa", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la sartén", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la olla exprés", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la cazuela", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el escurridor", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el colador", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el bol para mezclar", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el cucharón", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: "el abrelatas", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el sacacorchos", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la tabla de cortar", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el rallador", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el mortero", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el exprimidor", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el embudo", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el hervidor de agua", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
        ...
        file: "cocina13.png",
        hotspots: [
          { wort: "la pinza de azúcar", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el salero", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la bandeja", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el pimentero", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la panera", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la aceitera", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la vinagrera", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la botella", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el termo", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
        ...
        file: "cocina14.png",
        hotspots: [
          { wort: "la taza medidora", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la hielera", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el táper", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la fiambrera", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el bote", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el tarro", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el papel de aluminio", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el film transparente", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la bolsa de congelación", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
        ...
        hotspots: [
          ...
          { wort: "la cucharilla medidora", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el mantel", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la servilleta", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el paño de cocina", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el trapo", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el salvamanteles", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el delantal", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el guante de cocina", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      }
    ]
  },
  ...
  cocinaVajilla: {
    ...
    images: [
      ...
      },
      {
        ...
        file: "cocina8.png",
        hotspots: [
          { wort: "la taza", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el bol", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el vaso", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la jarra de cerveza", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la copa de vino", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la copa de cava", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la cafetera", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la tetera", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la jarra", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
        ...
        file: "cocina12.png",
        hotspots: [
          { wort: "la jarra de agua", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el azucarero", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la huevera", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la ensaladera", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la fuente", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la mantequera", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
  ...
  cocinaElectrodomesticos: {
    ...
    images: [
      ...
      },
      {
        ...
        file: "cocina16.png",
        hotspots: [
          { wort: "la freidora", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la freidora de aire", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la batidora de mano", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la batidora de varillas", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la batidora de vaso", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la licuadora", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la amasadora", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el robot de cocina", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el exprimidor eléctrico", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
        ...
        file: "cocina17.png",
        hotspots: [
          { wort: "el molinillo", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la báscula de cocina", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la gofrera", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la máquina de hacer pan", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el grill eléctrico", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la heladera", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la yogurtera", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la máquina de palomitas", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la envasadora al vacío", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      }
    ]
  },
    ...
    images: [
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: { es: "el cuelgallaves", de: "das Schlüsselbrett", en: "the key holder", ru: "ключница" }, clickX: 16.7, clickY: 83.3, labelX: 24, labelY: 75, areaW: 30, areaH: 28 },
  ...
  sotano: {
    ...
    images: [
      ...
      },
      {
        ...
        file: "sotano3.png",
        hotspots: [
          { wort: "la escalera", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el pasamanos", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el techo bajo", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el escalón", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la grieta", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la columna", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la puerta metálica", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "la ventana pequeña", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el tubo", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
      ...
      },
      {
        ...
        file: "sotano4.png",
        hotspots: [
          { wort: "el cable", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el fusible", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "la linterna", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 31 },
          { wort: "el manómetro", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "el radiador", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 30, areaH: 31 },
          { wort: "la válvula", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 30, areaH: 31 },
  ...
  bano: {
    ...
    images: [
      ...
      },
      {
        ...
        file: "bano2.png",
        hotspots: [
          { wort: "el lavabo", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 33 },
          { wort: "el grifo", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 33 },
          { wort: "el desagüe", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 33 },
          { wort: "el tapón", clickX: 16.8, clickY: 52.0, labelX: 16.8, labelY: 43.7, areaW: 30, areaH: 30 },
          { wort: "el agua fría", clickX: 50.0, clickY: 52.0, labelX: 50.0, labelY: 43.7, areaW: 30, areaH: 30 },
          { wort: "el agua caliente", clickX: 83.2, clickY: 52.0, labelX: 83.2, labelY: 43.7, areaW: 30, areaH: 30 },
          { wort: "el mueble bajo lavabo", clickX: 16.8, clickY: 82.8, labelX: 16.8, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el armario del baño", clickX: 50.0, clickY: 82.8, labelX: 50.0, labelY: 74.2, areaW: 30, areaH: 31 },
          { wort: "el espejo", clickX: 83.2, clickY: 82.8, labelX: 83.2, labelY: 74.2, areaW: 30, areaH: 31 }
        ]
      },
      {
        ...
        file: "bano3.png",
        hotspots: [
          { wort: "la ducha", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 30, areaH: 27 },
          { wort: "la alcachofa de la ducha", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 30, areaH: 27 },
          { wort: "la grifería de la ducha", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 30, areaH: 27 },
      ...
      },
      {
        ...
        file: "bano7.png",
        hotspots: [
          { wort: "el dispensador de jabón", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el cepillo de dientes", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la pasta de dientes", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
      ...
      },
      {
        ...
        file: "bano8.png",
        hotspots: [
          { wort: "el peine", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "el cepillo del pelo", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "el cepillo redondo", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 34 },
      ...
      },
      {
        ...
        file: "bano9.png",
        hotspots: [
          { wort: "el maquillaje", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "la máscara de pestañas", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "la barra de labios", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "el perfume", clickX: 16.8, clickY: 51.5, labelX: 16.8, labelY: 44.0, areaW: 31, areaH: 31 },
          { wort: "el desodorante", clickX: 50.0, clickY: 51.5, labelX: 50.0, labelY: 44.0, areaW: 31, areaH: 31 },
          { wort: "el espejo de mano", clickX: 83.2, clickY: 51.5, labelX: 83.2, labelY: 44.0, areaW: 31, areaH: 31 },
          { wort: "la diadema", clickX: 16.8, clickY: 83.0, labelX: 16.8, labelY: 75.5, areaW: 31, areaH: 31 },
          { wort: "el esmalte de uñas", clickX: 50.0, clickY: 83.0, labelX: 50.0, labelY: 75.5, areaW: 31, areaH: 31 },
          { wort: "el rizador de pestañas", clickX: 83.2, clickY: 83.0, labelX: 83.2, labelY: 75.5, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "bano10.png",
        hotspots: [
          { wort: "la maquinilla de afeitar", clickX: 16.8, clickY: 19.8, labelX: 16.8, labelY: 12.3, areaW: 31, areaH: 36 },
          { wort: "la espuma de afeitar", clickX: 50.0, clickY: 19.8, labelX: 50.0, labelY: 12.3, areaW: 31, areaH: 36 },
          { wort: "la afeitadora eléctrica", clickX: 83.2, clickY: 19.8, labelX: 83.2, labelY: 12.3, areaW: 31, areaH: 36 },
          { wort: "las pinzas", clickX: 16.8, clickY: 53.0, labelX: 16.8, labelY: 45.5, areaW: 31, areaH: 29 },
          { wort: "las tijeras de uñas", clickX: 50.0, clickY: 53.0, labelX: 50.0, labelY: 45.5, areaW: 31, areaH: 29 },
          { wort: "el cortauñas", clickX: 83.2, clickY: 53.0, labelX: 83.2, labelY: 45.5, areaW: 31, areaH: 29 },
          { wort: "la lima de uñas", clickX: 16.8, clickY: 84.2, labelX: 16.8, labelY: 76.8, areaW: 31, areaH: 29 },
          { wort: "la compresa", clickX: 50.0, clickY: 84.2, labelX: 50.0, labelY: 76.8, areaW: 31, areaH: 29 },
          { wort: "los tampones", clickX: 83.2, clickY: 84.2, labelX: 83.2, labelY: 76.8, areaW: 31, areaH: 29 }
        ]
      },
      {
        ...
        file: "bano11.png",
        hotspots: [
          { wort: "ducharse", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "bañarse", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "lavarse la cara", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 34 },
          { wort: "enjabonarse", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 34 },
          { wort: "lavarse el pelo", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 34 },
          { wort: "secarse", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 34 },
          { wort: "ponerse pasta de dientes", clickX: 16.8, clickY: 83.0, labelX: 16.8, labelY: 75.5, areaW: 31, areaH: 31 },
          { wort: "cepillarse los dientes", clickX: 50.0, clickY: 83.0, labelX: 50.0, labelY: 75.5, areaW: 31, areaH: 31 },
          { wort: "usar hilo dental", clickX: 83.2, clickY: 83.0, labelX: 83.2, labelY: 75.5, areaW: 31, areaH: 31 }
        ]
      },
      {
    ...
    images: [
      {
        ...
        hotspots: [
          { wort: "la secadora", clickX: 14.5, clickY: 38.0, labelX: 20.5, labelY: 31.5, areaW: 21, areaH: 23 },
          { wort: "la lavadora", clickX: 15.5, clickY: 66.5, labelX: 19.5, labelY: 63.5, areaW: 24, areaH: 24 },
          { wort: "el detergente", clickX: 30.0, clickY: 36.5, labelX: 36.0, labelY: 32.0, areaW: 10, areaH: 15 },
          { wort: "el suavizante", clickX: 37.8, clickY: 38.3, labelX: 43.5, labelY: 34.0, areaW: 9, areaH: 13 },
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: "la secadora", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la estantería", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el fregadero", clickX: 16.8, clickY: 51.5, labelX: 16.8, labelY: 44.0, areaW: 31, areaH: 31 },
          { wort: "el grifo", clickX: 50.0, clickY: 51.5, labelX: 50.0, labelY: 44.0, areaW: 31, areaH: 31 },
          { wort: "el interruptor", clickX: 83.2, clickY: 51.5, labelX: 83.2, labelY: 44.0, areaW: 31, areaH: 31 },
          { wort: "el enchufe", clickX: 16.8, clickY: 83.0, labelX: 16.8, labelY: 75.5, areaW: 31, areaH: 31 },
          { wort: "el tendedero", clickX: 50.0, clickY: 83.0, labelX: 50.0, labelY: 75.5, areaW: 31, areaH: 31 },
          { wort: "la cuerda de tender", clickX: 83.2, clickY: 83.0, labelX: 83.2, labelY: 75.5, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "lavadero3.png",
        hotspots: [
          { wort: "las pinzas de la ropa", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la tabla de planchar", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la plancha", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el cesto de la ropa", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la ropa sucia", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la percha", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el cubo de plástico", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "las palanganas de plástico", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el recogedor", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "lavadero4.png",
        hotspots: [
          { wort: "el cepillo", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el detergente en polvo", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el detergente líquido", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el suavizante", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el spray quitamanchas", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el tinte para ropa", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la lejía", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el jabón", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "las cápsulas de detergente", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "lavadero5.png",
        hotspots: [
          { wort: "clasificar la ropa", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "quitar una mancha", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "poner la lavadora", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "vaciar la lavadora", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "tender la ropa", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "secar la ropa", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
  ...
  despacho: {
    ...
    images: [
      ...
      },
      {
        ...
        file: "despacho2.png",
        hotspots: [
          { wort: "la pantalla", clickX: 58.0, clickY: 34.0, labelX: 67.0, labelY: 13.0, areaW: 58, areaH: 31 },
          ...
          { wort: "la alfombrilla", clickX: 93.0, clickY: 72.5, labelX: 84.0, labelY: 82.0, areaW: 10, areaH: 12 }
        ]
      },
      {
      ...
      },
      {
        ...
        file: "despacho4.png",
        hotspots: [
          { wort: "el portátil", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el teclado", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el ratón", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la alfombrilla", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la impresora", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el escáner", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el destructor de documentos", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el teléfono fijo", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el móvil", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "despacho5.png",
        hotspots: [
          { wort: "la calculadora", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la tableta", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "los auriculares", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el micrófono", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el altavoz", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la webcam", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el cargador", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "la memoria USB", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "la máquina de escribir", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "despacho6.png",
        hotspots: [
          { wort: "la perforadora", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la grapadora", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el quitagrapas", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el sacapuntas", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el sello", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la almohadilla para sellos", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el portarrollos de cinta adhesiva", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "la cinta adhesiva", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el sujetapapeles", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "despacho7.png",
        hotspots: [
          { wort: "la chincheta", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la goma de borrar", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la regla", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "las tijeras", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el corrector líquido", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el pegamento", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el pegamento en barra", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "las gomas elásticas", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el portalápices", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "despacho8.png",
        hotspots: [
          { wort: "el bolígrafo", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el lápiz", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "los lápices de colores", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "el rotulador", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el libro", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "las notas adhesivas", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el sobre", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "la hoja de papel", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el archivador", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      },
      {
        ...
        file: "despacho9.png",
        hotspots: [
          { wort: "el subrayador", clickX: 16.8, clickY: 18.3, labelX: 16.8, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la carpeta", clickX: 50.0, clickY: 18.3, labelX: 50.0, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "las fichas", clickX: 83.2, clickY: 18.3, labelX: 83.2, labelY: 10.8, areaW: 31, areaH: 31 },
          { wort: "la libreta", clickX: 16.8, clickY: 50.0, labelX: 16.8, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el cuaderno", clickX: 50.0, clickY: 50.0, labelX: 50.0, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "la agenda", clickX: 83.2, clickY: 50.0, labelX: 83.2, labelY: 42.5, areaW: 31, areaH: 31 },
          { wort: "el calendario de pared", clickX: 16.8, clickY: 81.7, labelX: 16.8, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "los documentos", clickX: 50.0, clickY: 81.7, labelX: 50.0, labelY: 74.2, areaW: 31, areaH: 31 },
          { wort: "el bloc de notas", clickX: 83.2, clickY: 81.7, labelX: 83.2, labelY: 74.2, areaW: 31, areaH: 31 }
        ]
      }
    ]
  },
    ...
    images: [
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: "los bloques de construcción", clickX: 28.0, clickY: 61.5, labelX: 29.5, labelY: 59.0, areaW: 24, areaH: 16 },
          { wort: "el libro infantil", clickX: 56.0, clickY: 63.5, labelX: 68.5, labelY: 58.0, areaW: 18, areaH: 14 },
          { wort: "el chupete", clickX: 23.0, clickY: 73.0, labelX: 26.0, labelY: 72.0, areaW: 10, areaH: 10 },
          { wort: "el sonajero", clickX: 39.0, clickY: 80.0, labelX: 50.5, labelY: 88.0, areaW: 16, areaH: 15 },
          { wort: "el osito de peluche", clickX: 63.5, clickY: 81.0, labelX: 78.5, labelY: 76.0, areaW: 15, areaH: 18 }
        ]
      },
      {
        ...
        file: "ninos4.png",
        hotspots: [
          { wort: "el armario", clickX: 16.7, clickY: 17.8, labelX: 24, labelY: 9.5, areaW: 30, areaH: 31 },
          { wort: "la cómoda", clickX: 50, clickY: 17.8, labelX: 50, labelY: 9.5, areaW: 30, areaH: 31 },
          { wort: "la cuna", clickX: 83.3, clickY: 17.8, labelX: 76, labelY: 9.5, areaW: 30, areaH: 31 },
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: "los juguetes", clickX: 16.7, clickY: 83.3, labelX: 24, labelY: 75, areaW: 30, areaH: 28 },
          { wort: "los lápices de colores", clickX: 50, clickY: 83.3, labelX: 50, labelY: 75, areaW: 30, areaH: 28 },
          { wort: "el papel", clickX: 83.3, clickY: 83.3, labelX: 76, labelY: 75, areaW: 30, areaH: 28 }
        ]
      },
      {
        ...
        hotspots: [
          ...
          { wort: "mecer al bebé", clickX: 50, clickY: 18.8, labelX: 50, labelY: 9.5, areaW: 30, areaH: 31 },
          { wort: "dar el biberón", clickX: 83.3, clickY: 18.8, labelX: 76, labelY: 9.5, areaW: 30, areaH: 31 },
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: "empujar el carrito", clickX: 50, clickY: 18.8, labelX: 50, labelY: 9.5, areaW: 30, areaH: 31 },
          { wort: "pesar al bebé", clickX: 83.3, clickY: 18.8, labelX: 76, labelY: 9.5, areaW: 30, areaH: 31 },
      ...
      },
      {
        ...
        hotspots: [
          ...
          { wort: "los auriculares", clickX: 90.5, clickY: 66.0, labelX: 81.5, labelY: 64.0, areaW: 16, areaH: 10 },
      ...
      },
      {
        ...
        file: "ninos14.png",
        hotspots: [
          { wort: "el libro", clickX: 16.7, clickY: 18.8, labelX: 24, labelY: 9.5, areaW: 30, areaH: 32 },
          { wort: "el papel", clickX: 50, clickY: 18.8, labelX: 50, labelY: 9.5, areaW: 30, areaH: 32 },
          { wort: "el bolígrafo", clickX: 83.3, clickY: 18.8, labelX: 76, labelY: 9.5, areaW: 30, areaH: 32 },
          { wort: "el cuaderno", clickX: 16.7, clickY: 52.8, labelX: 24, labelY: 42, areaW: 30, areaH: 31 },
          { wort: "los rotuladores", clickX: 50, clickY: 52.8, labelX: 50, labelY: 42, areaW: 30, areaH: 31 },
          { wort: "el estuche", clickX: 83.3, clickY: 52.8, labelX: 76, labelY: 42, areaW: 30, areaH: 31 },
          { wort: "la regla", clickX: 16.7, clickY: 83.3, labelX: 24, labelY: 75, areaW: 30, areaH: 28 },
          { wort: "las tijeras", clickX: 50, clickY: 83.3, labelX: 50, labelY: 75, areaW: 30, areaH: 28 },
          { wort: "la calculadora", clickX: 83.3, clickY: 83.3, labelX: 76, labelY: 75, areaW: 30, areaH: 28 }
        ]
      },
      {
      ...
      },
      {
        ...
        file: "ninos16.png",
        hotspots: [
          { wort: "tocar la guitarra", clickX: 16.7, clickY: 17.4, labelX: 24, labelY: 8.3, areaW: 30, areaH: 32 },
          { wort: "tocar el teclado", clickX: 50, clickY: 17.4, labelX: 50, labelY: 8.3, areaW: 30, areaH: 32 },
          { wort: "cantar", clickX: 83.3, clickY: 17.4, labelX: 76, labelY: 8.3, areaW: 30, areaH: 32 },
          { wort: "dibujar", clickX: 16.7, clickY: 51.2, labelX: 24, labelY: 40.5, areaW: 30, areaH: 31 },
          { wort: "pintar", clickX: 50, clickY: 51.2, labelX: 50, labelY: 40.5, areaW: 30, areaH: 31 },
          { wort: "escribir un diario", clickX: 83.3, clickY: 51.2, labelX: 76, labelY: 40.5, areaW: 30, areaH: 31 },
          { wort: "leer", clickX: 16.7, clickY: 83.3, labelX: 24, labelY: 75, areaW: 30, areaH: 32 },
          { wort: "escuchar música", clickX: 50, clickY: 83.3, labelX: 50, labelY: 75, areaW: 30, areaH: 32 },
          { wort: "hacer una fiesta con amigos", clickX: 83.3, clickY: 83.3, labelX: 76, labelY: 75, areaW: 30, areaH: 32 }
        ]
      },
      {
